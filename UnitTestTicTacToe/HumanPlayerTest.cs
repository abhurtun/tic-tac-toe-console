...
namespace TicTacToe.Tests
{
    ...
    public class HumanPlayerTest
    {
        ...
        public void GetNextMoveShouldAllOptions()
        {
            ...
            Assert.That(output.ToString(), Is.StringContaining(@"
| 1 | 2 | 3 |
| 4 | 5 | 6 |
| 7 | 8 | 9 |".Trim()));
        }
...
| 7 | 8 | 9 |".Trim()));
        ...
        public void GetNextMoveShouldPromptForMove()
        {
            input.WriteLine("1");
            player.GetNextMove();
            Assert.That(output.ToString(), Is.StringContaining("Select your move (1, 2, 3, 4, 5, 6, 7, 8, 9): "));
        }
        ...
        public void GetNextMoveShouldOnlyShowAvailableMoves()
        {
            ...
            game.MakeMoves("X1", "O2", "X3", "O4", "X5", "O6");
            player.GetNextMove();
            Assert.That(output.ToString(), Is.StringContaining("Select your move (7, 8, 9): "));
        }
        ...
        public void ShouldContinuePromptingOnInvalidInput()
        {
            ...
            Assert.That(output.ToString(), Is.StringContaining(prompt + prompt));
